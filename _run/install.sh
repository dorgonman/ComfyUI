...
HUNYUAN_MV_GATE_TEMPLATE_NAME="Hunyuan3D2MV_DefaultTamao_CanonicalGateV3_RTX3090.json"
HUNYUAN_MV_GATE_TEMPLATE_SOURCE="${SCRIPT_DIR}/templates/${HUNYUAN_MV_GATE_TEMPLATE_NAME}"
...
if [[ -f "${HUNYUAN_MV_GATE_TEMPLATE_SOURCE}" ]]; then
    mkdir -p "${USER_WORKFLOW_DIR}"
    cp -f "${HUNYUAN_MV_GATE_TEMPLATE_SOURCE}" "${USER_WORKFLOW_DIR}/${HUNYUAN_MV_GATE_TEMPLATE_NAME}"
fi
